...
import '../enum/vitals_enum.dart' as _i38;
import '../model/doctor_model/doctors_model.dart' as _i37;
...
import '../view/bottom_navigation_buttons/basket_view.dart' as _i34;
import '../view/bottom_navigation_buttons/favourites_view.dart' as _i33;
import '../view/bottom_navigation_buttons/home_view.dart' as _i31;
import '../view/bottom_navigation_buttons/set_appointment_view.dart' as _i32;
...
class AppRouter extends _i35.RootStackRouter {
  ...
  final Map<String, _i35.PageFactory> pagesMap = {
    ...
    HomeRoute.name: (routeData) {
      return _i35.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i31.HomeView(),
      );
    },
    SetAppointmentRoute.name: (routeData) {
      return _i35.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i32.SetAppointmentView(),
      );
    },
    FavouritesRoute.name: (routeData) {
      return _i35.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i33.FavouritesView(),
      );
    },
    BasketRoute.name: (routeData) {
      return _i35.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i34.BasketView(),
      );
    },
  };
...
/// generated route for
/// [_i2.Splash2View]
class Splash2Route extends _i35.PageRouteInfo<void> {
  const Splash2Route()
      : super(
          Splash2Route.name,
          path: '/splash',
...
class PinCodeVerificationRoute
    extends _i35.PageRouteInfo<PinCodeVerificationRouteArgs> {
...
/// generated route for
/// [_i10.MyDoctorView]
class MyDoctorRoute extends _i35.PageRouteInfo<void> {
  const MyDoctorRoute()
      : super(
          MyDoctorRoute.name,
          path: '/my-doctor',
...
/// generated route for
/// [_i11.MyRecordView]
class MyRecordRoute extends _i35.PageRouteInfo<void> {
  const MyRecordRoute()
      : super(
          MyRecordRoute.name,
          path: '/my-record',
...
class MyDoctorCategoryWiseRoute
    extends _i35.PageRouteInfo<MyDoctorCategoryWiseRouteArgs> {
...
class AllDoctorSearchRoute extends _i35.PageRouteInfo<void> {
...
/// generated route for
/// [_i14.DocDetailsView]
class DocDetailsRoute extends _i35.PageRouteInfo<DocDetailsRouteArgs> {
  DocDetailsRoute({
    _i36.Key? key,
    required num id,
  }) : super(
...
class BookAppointmentRoute
    extends _i35.PageRouteInfo<BookAppointmentRouteArgs> {
  BookAppointmentRoute({
    _i36.Key? key,
    required _i37.Doctors doctors,
...
/// generated route for
/// [_i17.InvoiceView]
class InvoiceRoute extends _i35.PageRouteInfo<void> {
  const InvoiceRoute()
      : super(
          InvoiceRoute.name,
          path: '/invoice',
...
/// generated route for
/// [_i18.AnatomyView]
class AnatomyRoute extends _i35.PageRouteInfo<void> {
  const AnatomyRoute()
      : super(
          AnatomyRoute.name,
          path: '/anatomy',
...
class SingleInvoiceRoute extends _i35.PageRouteInfo<SingleInvoiceRouteArgs> {
  SingleInvoiceRoute({
    _i36.Key? key,
    required String appointmentDate,
    required String doctorId,
...
/// generated route for
/// [_i20.VitalsView]
class VitalsRoute extends _i35.PageRouteInfo<void> {
  const VitalsRoute()
      : super(
          VitalsRoute.name,
          path: '/vital',
...
class MyMedicalHistoryRoute extends _i35.PageRouteInfo<void> {
...
class SelfMedicalHistoryFGDRoute extends _i35.PageRouteInfo<void> {
...
class ReasonForVisitRoute extends _i35.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.MyReportView]
class MyReportRoute extends _i35.PageRouteInfo<void> {
  const MyReportRoute()
      : super(
          MyReportRoute.name,
          path: '/my-report',
...
class VitalsItemDetailsRoute
    extends _i35.PageRouteInfo<VitalsItemDetailsRouteArgs> {
  VitalsItemDetailsRoute({
    _i36.Key? key,
    required String title,
    required String img,
    required String subtitle,
    required _i38.Vitals v,
  }) : super(
          VitalsItemDetailsRoute.name,
          path: '/vitals-detail',
...
/// generated route for
/// [_i26.MyMedicineView]
class MyMedicineRoute extends _i35.PageRouteInfo<void> {
...
/// generated route for
/// [_i27.RXView]
class RXRoute extends _i35.PageRouteInfo<void> {
  const RXRoute()
      : super(
          RXRoute.name,
          path: '/rx',
...
/// generated route for
/// [_i28.RXDetailView]
class RXDetailRoute extends _i35.PageRouteInfo<RXDetailRouteArgs> {
  RXDetailRoute({
    _i36.Key? key,
    required String title,
...
class DailyAndUpcommingRoute extends _i35.PageRouteInfo<void> {
...
class DailyAndUpcommingDetailRoute
    extends _i35.PageRouteInfo<DailyAndUpcommingDetailRouteArgs> {
...
/// generated route for
/// [_i32.SetAppointmentView]
class SetAppointmentRoute extends _i35.PageRouteInfo<void> {
...
/// generated route for
/// [_i34.BasketView]
class BasketRoute extends _i35.PageRouteInfo<void> {
  const BasketRoute()
      : super(
          BasketRoute.name,
          path: 'basket',
