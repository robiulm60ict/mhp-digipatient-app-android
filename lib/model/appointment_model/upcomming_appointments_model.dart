...
class UpcommingAppointmentsModel {
  ...
  UpcommingAppointmentsModel.fromJson(dynamic json) {
    status = json['status'];
    message = json['message'];
    if (json['upcomingPatientAppointments'] != null) {
      upcomingPatientAppointments = [];
      json['upcomingPatientAppointments'].forEach((v) {
        upcomingPatientAppointments?.add(UpcomingPatientAppointments.fromJson(v));
      });
    }
  ...
  num? status;
  String? message;
  List<UpcomingPatientAppointments>? upcomingPatientAppointments;
  num? totalUpcomingLists;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['status'] = status;
    map['message'] = message;
    if (upcomingPatientAppointments != null) {
      map['upcomingPatientAppointments'] = upcomingPatientAppointments?.map((v) => v.toJson()).toList();
    }
    map['totalUpcomingLists'] = totalUpcomingLists;
    return map;
  }

}

UpcomingPatientAppointments upcomingPatientAppointmentsFromJson(String str) => UpcomingPatientAppointments.fromJson(json.decode(str));
String upcomingPatientAppointmentsToJson(UpcomingPatientAppointments data) => json.encode(data.toJson());
class UpcomingPatientAppointments {
  UpcomingPatientAppointments({
      this.id, 
      this.doctorsId, 
      this.patientId, 
  ...
  UpcomingPatientAppointments.fromJson(dynamic json) {
    id = json['id'];
