...
//
//     final doctorsModels = doctorsModelsFromJson(jsonString);

import 'dart:convert';

DoctorsModels doctorsModelsFromJson(String str) => DoctorsModels.fromJson(json.decode(str));

String doctorsModelsToJson(DoctorsModels data) => json.encode(data.toJson());
