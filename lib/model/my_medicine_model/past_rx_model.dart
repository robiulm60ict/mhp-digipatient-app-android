...
import 'current_rx_model.dart';
PastRxModel pastRxModelFromJson(String str) => PastRxModel.fromJson(json.decode(str));
String pastRxModelToJson(PastRxModel data) => json.encode(data.toJson());
class PastRxModel {
  PastRxModel({
      this.status, 
      this.message, 
  ...
  PastRxModel.fromJson(dynamic json) {
    status = json['status'];
