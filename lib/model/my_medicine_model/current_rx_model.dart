...
//
//     final currentRxModel = currentRxModelFromJson(jsonString);

import 'dart:convert';

List<CurrentRxModel> currentRxModelFromJson(String str) => List<CurrentRxModel>.from(json.decode(str).map((x) => CurrentRxModel.fromJson(x)));

String currentRxModelToJson(List<CurrentRxModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CurrentRxModel {
  ...
  factory CurrentRxModel.fromJson(Map<String, dynamic> json) => CurrentRxModel(
    id: json["id"],
