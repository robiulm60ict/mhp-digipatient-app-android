...
class EducationResourceView extends StatefulWidget {
  const EducationResourceView({super.key});

  @override
  State<EducationResourceView> createState() => _EducationResourceViewState();
}

class _EducationResourceViewState extends State<EducationResourceView> {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ResourcesViewModel>().getnewsResouresData();
    });
      ...
      child: Scaffold(
          ...
          body: Consumer<ResourcesViewModel>(builder: (context, provider, child) {
            if (provider.newsList.isEmpty) {
              return provider.isNewsLoading == true
                  ? ListView.builder(
                    itemCount: 6,
                      ...
                      Padding(
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, index) {
                              var resoures = provider.newsList[index];
                              return Column(
                                children: [
                                  Card(
                                    elevation: 8,
