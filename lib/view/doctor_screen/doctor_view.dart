...
class _DoctorHomeViewState extends State<DoctorHomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    var allP = Provider.of<DoctorScreenViewModel>(context);
    return RefreshIndicator(onRefresh: () async{
      allP.getAllPatientList(context);
    },
    child: Scaffold(
      appBar: AppBar(
        centerTitle: true,
      ...
      body:  Column(
        children: [
              ...
              builder: (patient) => Padding(
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(onPressed: (){
                      videoCall.getVideoCallToken(context, appId: appId, channelName: cName, userId: cName, fcmToken: "${patient.appToken}");
          ...
          allP.allPatientList.isNotEmpty ? Expanded(child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                trailing: IconButton(onPressed: (){
                  videoCall.getVideoCallToken(context, appId: appId, channelName: cName, userId: cName, fcmToken: "${allPatients[index].appToken}");
                }, icon: Icon(Icons.video_call, color: AppColors.primaryColor,)),
              );
