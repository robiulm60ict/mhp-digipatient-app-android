          ...
          Row(
              ...
              children: [
                ...
                SizedBox(
                    width: 150.w,
                    child: Text(
                        "${doctor!.title!.titleName.toString()} ${doctor!.fullName.toString()}"))
              ]),
          SizedBox(height: 2),
          Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                ...
                SizedBox(
                    width: 150.w,
                    child: Text(doctor!.department!.departmentsName
                        .toString())),
              ]),
          SizedBox(height: 2),
          Row(
              ...
              children: [
                ...
                SizedBox(
                    width: 150.w,
                    child: Text(
                      "${doctor?.usualProvider != null ? doctor?.usualProvider?.usualProviderName.toString() : ""}",
                    )),
              ]),
          SizedBox(height: 2),
        ]),
