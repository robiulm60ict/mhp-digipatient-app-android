...
class BrancePatientQurio extends StatefulWidget {
  BrancePatientQurio({super.key, required this.todaysPatientAppointment,required this.databasename,required this.branceid});
  ...
  @override
  State<BrancePatientQurio> createState() => _PatientQurioState();
}

class _PatientQurioState extends State<BrancePatientQurio> {
  ...
  Future<void> fetchData(docId, appoitmentId) async {
    ...
    try {
      print(docId);
      print(appoitmentId);
      print(widget.branceid.toString());
      print(widget.databasename.toString());
      final response = await http.get(
        Uri.parse(
            "${AppUrls.baseUrlPatient}/patient-appointment-queue-number/$docId/$appoitmentId"),
        headers: {
          'token': "$token",
          'databaseName': '${widget.databasename.toString()}',
  ...
  @override
  void didUpdateWidget(covariant BrancePatientQurio oldWidget) {
