...
class MyClinicAppoinmentView extends StatefulWidget {
  const MyClinicAppoinmentView({super.key});

  @override
  State<MyClinicAppoinmentView> createState() => _MyClinicViewState();
}

class _MyClinicViewState extends State<MyClinicAppoinmentView> {
  @override
  void initState() {
