...
class _DailyAndUpcommingViewState extends State<DailyAndUpcommingView> {
  ...
  Widget build(BuildContext context) {
      ...
      body: Column(
        children: [
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text("Todays Appointments", style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w500, color: showTodayAppointments ? Colors.white : AppColors.primaryColor),),
                ),
              ),
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text("Upcomming Appointments", style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w500, color: !showTodayAppointments ? Colors.white : AppColors.primaryColor),),
                ),
              ),
            ],
          ),
          ...
          Expanded(child: Visibility(
            ...
            replacement: appointments.isUpcommingAppointmentLoading ? const CircularProgressIndicator() : ListView.builder(
    ...
    docImage: "${AppUrls.docImage}${app.drImages}",
            ...
            child: appointments.isTodayAppointmentLoading ? const CircularProgressIndicator() : ListView.builder(
