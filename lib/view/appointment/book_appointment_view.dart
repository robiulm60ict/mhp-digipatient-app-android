                          ...
                          MaterialPageRoute(
                              builder: (context) => PaymentMethodView(
                                  ...
                                  appointmentViewModel
                                      ...
                                      .split(" ")
                                      .first,
                                  appointmentType: appointmentViewModel.isChamber ? "Chamber" : "Online",
                                  doctorId: "${widget.doctors.doctorsMasterId}",
                                  patientId: "$value",
                                  amount: appointmentViewModel.isChamber
                                      ? widget.amount
                                      : appointmentViewModel.online_amount.toString(),
                                  doctor: widget.doctors,
                                  diseaseList: diseaseList,
                                  shiftType:
                                  appointmentViewModel.morningButton ? "morning" : "evening"))));
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: Card(
                        color: appointmentViewModel.isChamber ? AppColors.primaryColor : Colors.white,
                        child: ListTile(
                          onTap: () {
                    ...
                    Expanded(
                      child: Card(
                        color: appointmentViewModel.isChamber ? Colors.white : AppColors.primaryColor,
                        child: ListTile(
                          onTap: () {
                ...
                Row(
                  children: [
                    Expanded(
                      child: Card(
                        color: appointmentViewModel.morningButton ? AppColors.primaryColor : Colors.white,
                        child: ListTile(
                          onTap: () {
                    ...
                    Expanded(
                      child: Card(
                        color:appointmentViewModel. morningButton ? Colors.white : AppColors.primaryColor,
                        child: ListTile(
                          onTap: () {
                ...
                SizedBox(
                    height: 80.h,
                    child: Consumer<MyDoctorViewModel>(builder: (context, myDocVM, child) {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(": "),
                                  Text(appointmentViewModel.isChamber ? "Chamber" : "Online"),
                                ],
                              ),
                              Style.distan_size2,
                              Row(
                                children: [
                                  ...
                                  Text(": "),
                                  Text(appointmentViewModel.morningButton ? "morning" : "evening"),
                                ],
                              ),
                              Style.distan_size2,
                              Row(
