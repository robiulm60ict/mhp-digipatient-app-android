...
class PaymentCatagoryView extends StatefulWidget {
  const PaymentCatagoryView({super.key});

  @override
  State<PaymentCatagoryView> createState() => _AppoinmentCatagoryViewState();
}

class _AppoinmentCatagoryViewState extends State<PaymentCatagoryView> {
          ...
          children: [Style.distan_size15,
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    clinic.paymentcatagoryItemsRouteTo(context, index);
                  },
                  child: Container(
