...
import 'appoinemnt_clinic_branches_view.dart';

class MyClinicLabView extends StatefulWidget {
  const MyClinicLabView({super.key});

  @override
  State<MyClinicLabView> createState() => _MyClinicViewState();
}

class _MyClinicViewState extends State<MyClinicLabView> {
  @override
  void initState() {
                            ...
                            return InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => ClinicLabBranches(organizationListModle: organzation,)));
                              },
                              child: Container(
